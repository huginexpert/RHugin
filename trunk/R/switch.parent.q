switch.parent <- function(domain, child, parent, new.parent)
{
  ...
  child.ptr <- .Call("RHugin_domain_get_node_by_name", domain$pointer, child,
                      PACKAGE = "RHugin")
  RHugin.handle.error()
  parent.ptr <- .Call("RHugin_domain_get_node_by_name", domain$pointer, parent,
                       PACKAGE = "RHugin")
  RHugin.handle.error()
  new.parent.ptr <- .Call("RHugin_domain_get_node_by_name", domain$pointer,
