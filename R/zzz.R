...
{
      HuginDllDir <- "C:/Program Files/Hugin Expert/HUGIN 9.7 (x64)/HDE9.7C/Lib/VC17/Release" ###ConfigureHuginDllDirHere###
  
  if(Sys.info()["sysname"] == "Windows") {
      HuginVersion <- "HUGIN 9.7 (x64)" ###ConfigureHuginVersionHere###
      HuginInst <- "C:/Program Files/Hugin Expert/HUGIN 9.7 (x64)" ###ConfigureHuginDirHere###
