...
SEXP RHugin_node_enter_finding(SEXP Snode, SEXP Sstate, SEXP Svalues)
{
  SEXP ret = R_NilValue;
  h_node_t node = NULL;
  ...
  if(LENGTH(Sstate) == LENGTH(Svalues)) {
...
SEXP RHugin_node_set_case_value(SEXP Snode, SEXP Scase_index, SEXP Svalues)
{
  SEXP ret = R_NilValue;
  h_node_t node = NULL;
